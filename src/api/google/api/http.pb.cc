...
inline constexpr CustomHttpPattern::Impl_::Impl_(
    ...
    : kind_(&::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
      path_(&::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
      _cached_size_{0} {}

template <typename>
PROTOBUF_CONSTEXPR
CustomHttpPattern::CustomHttpPattern(::_pbi::ConstantInitialized)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CustomHttpPatternDefaultTypeInternal
        _CustomHttpPattern_default_instance_;

inline constexpr HttpRule::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : additional_bindings_{},
      selector_(&::google::protobuf::internal::fixed_address_empty_string,
                ::_pbi::ConstantInitialized()),
      body_(&::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
      response_body_(&::google::protobuf::internal::fixed_address_empty_string,
                     ::_pbi::ConstantInitialized()),
      pattern_{}, _cached_size_{0}, _oneof_case_{} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HttpRuleDefaultTypeInternal
        _HttpRule_default_instance_;

inline constexpr Http::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : rules_{}, fully_decode_reserved_expansion_{false}, _cached_size_{0} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HttpDefaultTypeInternal
...
const ::uint32_t TableStruct_google_2fapi_2fhttp_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        PROTOBUF_FIELD_OFFSET(::google::api::Http,
        ...
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::api::CustomHttpPattern,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
...
const char descriptor_table_protodef_google_2fapi_2fhttp_2eproto
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        "\001(\tH\000R\003put\022"
        "\024\n\004post\030\004 "
        "\001(\tH\000R\004post\022\030\n\006delete\030\005 \001(\tH\000R"
        "\006delete\022\026\n\005patch\030\006 "
        "\001(\tH\000R\005patch\0227\n\006custo"
...
Http::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                   ::google::protobuf::Arena *arena, const Impl_ &from,
                   const ::google::api::Http &from_msg)
    : rules_{visibility, arena, from.rules_}, _cached_size_{0} {}

Http::Http(::google::protobuf::Arena *arena, const Http &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
  ...
  _impl_.fully_decode_reserved_expansion_ =
      from._impl_.fully_decode_reserved_expansion_;
...
Http::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
    ...
    : rules_{visibility, arena}, _cached_size_{0} {}
...
const ::google::protobuf::MessageLite::ClassDataFull Http::_class_data_ = {
    ::google::protobuf::Message::ClassData{
        ...
        &Http::MergeImpl,
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::google::protobuf::Message::GetDeleteImpl<Http>(),
        ::google::protobuf::Message::GetNewImpl<Http>(),
        ::google::protobuf::Message::GetClearImpl<Http>(),
        &Http::ByteSizeLong,
    ...
    &Http::kDescriptorMethods, &descriptor_table_google_2fapi_2fhttp_2eproto,
    nullptr, // tracker
};
const ::google::protobuf::MessageLite::ClassData *Http::GetClassData() const {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<
    ...
    Http::_table_ = {
        ...
        {{
            // bool fully_decode_reserved_expansion = 2 [json_name =
            // "fullyDecodeReservedExpansion"];
            {::_pbi::TcParser::SingularVarintNoZag1<
                 bool, offsetof(Http, _impl_.fully_decode_reserved_expansion_),
                 63>(),
             {16, 63, 0,
              PROTOBUF_FIELD_OFFSET(Http,
                                    _impl_.fully_decode_reserved_expansion_)}},
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *
Http::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
...
::uint8_t *Http::_InternalSerialize(
  ...
  // repeated .google.api.HttpRule rules = 1 [json_name = "rules"];
  for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_rules_size());
       i < n; i++) {
...
void Http::MergeImpl(::google::protobuf::MessageLite &to_msg,
  ...
  if (from._internal_fully_decode_reserved_expansion() != 0) {
    _this->_impl_.fully_decode_reserved_expansion_ =
        from._impl_.fully_decode_reserved_expansion_;
  }
...
void Http::InternalSwap(Http *PROTOBUF_RESTRICT other) {
  ...
  swap(_impl_.fully_decode_reserved_expansion_,
       other->_impl_.fully_decode_reserved_expansion_);
}
...
inline PROTOBUF_NDEBUG_INLINE HttpRule::Impl_::Impl_(
    ...
    : additional_bindings_{visibility, arena, from.additional_bindings_},
      selector_(arena, from.selector_), body_(arena, from.body_),
      response_body_(arena, from.response_body_), pattern_{}, _cached_size_{0},
      _oneof_case_{from._oneof_case_[0]} {}

HttpRule::HttpRule(::google::protobuf::Arena *arena, const HttpRule &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
  ...
  case PATTERN_NOT_SET:
    break;
  case kGet:
    new (&_impl_.pattern_.get_) decltype(_impl_.pattern_.get_){
        arena, from._impl_.pattern_.get_};
    break;
  case kPut:
    new (&_impl_.pattern_.put_) decltype(_impl_.pattern_.put_){
        arena, from._impl_.pattern_.put_};
    break;
  case kPost:
    new (&_impl_.pattern_.post_) decltype(_impl_.pattern_.post_){
        arena, from._impl_.pattern_.post_};
    break;
  case kDelete:
    new (&_impl_.pattern_.delete__) decltype(_impl_.pattern_.delete__){
        arena, from._impl_.pattern_.delete__};
    break;
  case kPatch:
    new (&_impl_.pattern_.patch_) decltype(_impl_.pattern_.patch_){
        arena, from._impl_.pattern_.patch_};
    break;
  case kCustom:
    _impl_.pattern_.custom_ = ::google::protobuf::Message::CopyConstruct<
        ::google::api::CustomHttpPattern>(arena, *from._impl_.pattern_.custom_);
    break;
  }
...
inline PROTOBUF_NDEBUG_INLINE HttpRule::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena *arena)
    : additional_bindings_{visibility, arena}, selector_(arena), body_(arena),
      response_body_(arena), pattern_{}, _cached_size_{0}, _oneof_case_{} {}
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataFull HttpRule::_class_data_ = {
    ::google::protobuf::Message::ClassData{
        ...
        &HttpRule::MergeImpl,
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::google::protobuf::Message::GetDeleteImpl<HttpRule>(),
        ::google::protobuf::Message::GetNewImpl<HttpRule>(),
        ::google::protobuf::Message::GetClearImpl<HttpRule>(),
        &HttpRule::ByteSizeLong,
    ...
    HttpRule::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::google::api::HttpRule>(), // to_prefetch
#endif                                      // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            ...
            {::_pbi::TcParser::MiniParse, {}},
            // repeated .google.api.HttpRule additional_bindings = 11 [json_name
            // = "additionalBindings"];
            {::_pbi::TcParser::FastMtR1,
             {90, 63, 1,
        ...
        {{
            ...
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.get_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // string put = 3 [json_name = "put"];
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.put_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // string post = 4 [json_name = "post"];
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.post_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // string delete = 5 [json_name = "delete"];
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.delete__),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // string patch = 6 [json_name = "patch"];
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.patch_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // string body = 7 [json_name = "body"];
            ...
            {PROTOBUF_FIELD_OFFSET(HttpRule, _impl_.pattern_.custom_),
             _Internal::kOneofCaseOffset + 0, 0,
...
::uint8_t *HttpRule::_InternalSerialize(
  ...
  if (this_.pattern_case() == kCustom) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        8, *this_._impl_.pattern_.custom_,
        this_._impl_.pattern_.custom_->GetCachedSize(), target, stream);
  }
  ...
  for (unsigned i = 0, n = static_cast<unsigned>(
    ...
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        11, repfield, repfield.GetCachedSize(), target, stream);
  }
      ...
      if (oneof_needs_init) {
        _this->_impl_.pattern_.custom_ =
            ::google::protobuf::Message::CopyConstruct<
                ...
                arena, *from._impl_.pattern_.custom_);
      } else {
...
void HttpRule::InternalSwap(HttpRule *PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.body_, &other->_impl_.body_,
                                       arena);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.response_body_,
                                       &other->_impl_.response_body_, arena);
...
inline PROTOBUF_NDEBUG_INLINE CustomHttpPattern::Impl_::Impl_(
    ...
    : kind_(arena, from.kind_), path_(arena, from.path_), _cached_size_{0} {}
...
inline PROTOBUF_NDEBUG_INLINE CustomHttpPattern::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena *arena)
    : kind_(arena), path_(arena), _cached_size_{0} {}
...
const ::google::protobuf::MessageLite::ClassDataFull
    CustomHttpPattern::_class_data_ = {
        ::google::protobuf::Message::ClassData{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<CustomHttpPattern>(),
            ::google::protobuf::Message::GetNewImpl<CustomHttpPattern>(),
            ::google::protobuf::Message::GetClearImpl<CustomHttpPattern>(),
            &CustomHttpPattern::ByteSizeLong,
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
                ::_pbi::TcParser::GetTable<
                    ::google::api::CustomHttpPattern>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
            },
            {{
...
void CustomHttpPattern::MergeImpl(
...
void CustomHttpPattern::InternalSwap(
    CustomHttpPattern *PROTOBUF_RESTRICT other) {
  using std::swap;
  auto *arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.kind_, &other->_impl_.kind_,
                                       arena);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.path_, &other->_impl_.path_,
                                       arena);
}
