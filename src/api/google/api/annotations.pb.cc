...
static const ::_pbi::DescriptorTable
    *const descriptor_table_google_2fapi_2fannotations_2eproto_deps[2] = {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
    ...
    ::_pbi::MessageTypeTraits<::google::api::HttpRule>, 11, false>
    ...
    PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(
         ...
         ::_pbi::ExtensionSet::RegisterMessageExtension(
             &::google::protobuf::MethodOptions::default_instance(), 72295728,
             11, false, false, &::google::api::HttpRule::default_instance(),
